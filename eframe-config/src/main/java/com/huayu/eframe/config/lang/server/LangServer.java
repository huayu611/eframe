...
public class LangServer
{
    ...
    public Object addLangText(@RequestBody AddLangValueRequest addLangValueRequest, EasyParam easyParam)
    {
    ...
    public Object modifyLangText(@RequestBody ModifyLangValueRequest request, EasyParam easyParam)
    {
