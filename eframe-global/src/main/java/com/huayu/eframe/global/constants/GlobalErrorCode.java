package com.huayu.eframe.global.constants;
...
{
    String VALUE_IN_REQUEST_NOT_SUIT_DICT = "15001";

    String EMAIL_CODE_EXIST_ALREADY = "15002";

    String EMAIL_NOT_EXIST_WHEN_UPDATE = "15003";

    String EMAIL_UPDATING_FAILED = "15004";
