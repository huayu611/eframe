...
@Configuration
@RestController
@RequestMapping(value = "/eview/dict")
public class PublicDictionaryRestServer
{
    @ResponseBody
    ...
    public Object queryPublicDictByCode(@PathVariable String code, EasyParam easyParam)
    {
